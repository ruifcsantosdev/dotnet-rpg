    ...
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<FightResultDto>> Fight(FightRequestDto request)
        {
            ...
            try
            {
                ...
                this.context.Characters.UpdateRange(characters);
        ...
        {
            List<Character> characters = await this.context.Characters
                .Where(c => c.Fights > 0)
            ...
            {
                Data = characters.Select(c => this.mapper.Map<HighscoreDTO>(c)).ToList()
            };
            return response;
        }
    }
